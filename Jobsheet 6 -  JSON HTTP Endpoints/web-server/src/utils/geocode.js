...
const geocode = (address, callback) => {
    ...
    const url = `https://nominatim.openstreetmap.org/search?q=${place}&format=json&limit=3`
    
    request({url, json: true,headers: { 'User-Agent': 'NetworkProgramming-Project/1.0' }},(err, res) => {
